...
public class FoozPadUtils {
    public enum FoozPadColors {
        NURAZ_DEFAULT(new LedEffect.Builder()
        ...
        public final LedEffect colorPattern;

        FoozPadColors(LedEffect pattern) {
    ...
    public enum FoozPadRumble {
        ...
        public final RumbleEffect rumblePattern;

        FoozPadRumble(RumbleEffect rumblePattern) {
