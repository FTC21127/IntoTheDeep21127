...
public class Drivetrain extends Mechanism {
    ...
    public void loop(FoozPad gamepad) {
        ...
        double x = -gamepad.gamepad.left_stick_x*.8;
        double r = -gamepad.gamepad.right_stick_x * .65;

        y = y * (1-gamepad.gamepad.left_trigger) * (1 + .25 * (gamepad.gamepad.right_bumper?1:0));
        x = x * (1-gamepad.gamepad.left_trigger) * (1 + .25 * (gamepad.gamepad.right_bumper?1:0));
