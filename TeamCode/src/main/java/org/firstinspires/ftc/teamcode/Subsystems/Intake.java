...
public class Intake extends Mechanism {
    ...
    public static double BAR_DOWN = 0.16;
    public static double BAR_Intermediate_DOWN = 0.35;
    public static double BARPICKUP = 0.11;
    public static double AUTON_DOWN = 0.13;

    public static double AUTON_intermediate = 0.6;
    public static double BAR_TRANSFER = 0.72;
    public static double BAR_NEUTRAL = 0.5;
    public static double BAR_FOLD = 0.76;
