...
public class FollowerConstants {
    ...
    private static double xMovement = 79.777;
    private static double yMovement = 39.8885;
    ...
    public static double mass = 5.22;
    ...
    public static double forwardZeroPowerAcceleration = -33.0679;
