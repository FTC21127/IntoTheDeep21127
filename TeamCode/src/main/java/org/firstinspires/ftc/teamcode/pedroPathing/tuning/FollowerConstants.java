...
public class FollowerConstants {
    ...
    private static double xMovement = 75.7945;
    private static double yMovement = 25.2023660483121535;
    ...
    public static double forwardZeroPowerAcceleration = -32.13227;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -31.730436690887455333;
